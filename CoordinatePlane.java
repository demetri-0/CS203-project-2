...
public class CoordinatePlane {
    ...
    public CoordinatePlane(int numPoints, int bounds) throws IllegalArgumentException {
        ...
        if (numPoints > Math.pow((bounds * 2) + 1, 2)) { // throws exception if plane cannot be built
    ...
    Input: 2 lists of points, sorted by X and Y
    ...
    /*
    Finds the closest pair of points for 3 or 2 points by Brute Force (testing every combination).
